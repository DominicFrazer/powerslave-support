...
apps. Plain HTML/CSS, no build step, no JavaScript beyond a copyright year, a computed year count, and
one legacy-anchor redirect. Hosted free on GitHub Pages at [powerslave.dev](https://powerslave.dev).
